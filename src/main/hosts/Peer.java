...
public class Peer {
    ...
    public Peer(int peerID, String hostname, int port, String pathPrefix) throws FileNotFoundException {
    ...
    public Peer(int peerID, String hostname, int port) throws FileNotFoundException {
